...
export const metadata: Metadata = {
  title: "Golden Bay Hotel - Luxury Ocean View Accommodations",
  description: "Experience world-class luxury at Golden Bay Hotel with stunning ocean views, premium amenities, fine dining, and exceptional service. Book your perfect getaway today.",
  keywords: "luxury hotel, ocean view, spa, fine dining, premium accommodations, resort, vacation, Golden Bay",
  metadataBase: new URL("https://goldenbayhotel.com"),
  alternates: {
    canonical: "https://goldenbayhotel.com"
  },
  openGraph: {
    title: "Golden Bay Hotel - Luxury Ocean View Accommodations",
    description: "Experience world-class luxury at Golden Bay Hotel with stunning ocean views, premium amenities, and exceptional service.",
    siteName: "Golden Bay Hotel",
    images: [
      {
        url: "https://images.pexels.com/photos/14011664/pexels-photo-14011664.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Golden Bay Hotel luxury lobby"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Golden Bay Hotel - Luxury Ocean View Accommodations",
    description: "Experience world-class luxury at Golden Bay Hotel with stunning ocean views, premium amenities, and exceptional service.",
    images: ["https://images.pexels.com/photos/14011664/pexels-photo-14011664.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
